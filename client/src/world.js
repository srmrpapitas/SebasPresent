...
export async function startWorld(loggedInUser, token) {
  ...
  try {
    ...
    // [ROLLBACK sesión 17/18] damage_splat desactivado mientras debuggeamos
...
export function stopWorld() {
  ...
  // [ROLLBACK] damage_splat desactivado
  ...
  // [ROLLBACK sesión 18] HP bar cleanup removido
  authToken = null;
  positionSaveTimer = 0;
  runMode = false;
...
function updateNameTag() {
  ...
  // [ROLLBACK sesión 18] HP bar desactivada mientras debuggeamos
}

// [ROLLBACK sesión 18] funciones HP bar removidas mientras debuggeamos
