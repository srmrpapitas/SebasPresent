...
function updateMultiplayer(dt) {
  ...
  // 3) Interpolar visual de peers cada frame
...
function createMpPeer(p) {
  // Placeholder visual: cápsula con color por hash del nombre + label flotante.
  // Más adelante (slice 5f) reemplazamos esto por Nico clonado con SkeletonUtils.
  const group = new THREE.Group();

  // Color por hash de username — cada player tendrá un tinte único reconocible
  ...
  // CSS inline simple (consistente con name tag del player)
