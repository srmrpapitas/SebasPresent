...
function animate() {
  ...
  if (character) {
    character.update(dt);
    // Fijar Y del player a 0 (mismo enfoque que los NPCs: group.position.y = 0).
    // Esto evita que la animación o el bbox del modelo (que incluye capa/túnica
    // colgando por debajo de los pies) muevan al personaje verticalmente.
