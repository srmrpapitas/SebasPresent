...
export function initSidebar({ onLogout } = {}) {
  ...
  // Sesión 42 — Highscores: init del overlay (el botón vive en el panel de
  // skills que arma world.js → se cablea allá, no acá).
  try { highscores.init(); } catch (e) { console.warn('[ui] highscores.init error:', e); }
