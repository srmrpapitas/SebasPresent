...
| `__sebasDebug` | Acceso a state interno (DEBUG) | `world.js` | DevTools / consola |
| `__otherPlayers` | Estado de peers (DEBUG) | `world.js` | DevTools / consola |
| `__mpPlayers` | Mapa de peers visibles (DEBUG) | `world.js` | DevTools / consola |
| `__sebasOffsetY` | Offset Y del player (DEBUG) | `world.js` (opcional) | DevTools / consola |
